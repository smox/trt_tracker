...
import 'package:trt_tracker/data/models/user_profile_model.dart';
...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
  ...
  int _currentPage = 0;
  // Wir haben jetzt 4 Seiten: Info -> Personal -> Stats -> Therapie
  ...
  void _submitData() async {
    if (_formKey.currentState!.validate()) {
      ...
      final int startDateMillis =
          _therapyStartDate?.millisecondsSinceEpoch ??
          DateTime.now().millisecondsSinceEpoch;
  ...
  void _nextPage() {
    // Wenn wir noch nicht auf der letzten Seite sind (Index 3)
  ...
  // --- NEU: SEITE 0 (Info & Disclaimer) ---
  // --- SEITE 0 (Info & Disclaimer) - SCROLLBAR GEMACHT ---
  Widget _buildPage0Info() {
    return Center(
      child: SingleChildScrollView(
        // Padding ist jetzt im ScrollView, damit auch oben/unten etwas Luft beim Scrollen ist
        padding: const EdgeInsets.all(24.0),
        child: Column(
          ...
          children: [
            ...
            _buildInfoBlock(
              ...
              text:
                  "Diese App dient ausschließlich deiner persönlichen Information. Die angezeigten Werte basieren auf mathematischen Schätzungen und stellen keine medizinische Diagnose dar. Sie ersetzen keinesfalls ärztliche Beratung oder regelmäßige Blutuntersuchungen.",
            ),
            ...
            _buildInfoBlock(
              ...
              text:
                  "Die App berechnet den theoretischen Abbau des Wirkstoffs basierend auf deinen Eingaben und dem durchschnittlichen Stoffwechsel. \n\nDa jeder Körper anders ist, lernt die App dazu: Sobald du echte Blutwerte einträgst, kalibriert sich die Kurve automatisch auf deinen individuellen Stoffwechsel.",
            ),

            // Kleiner Puffer unten, damit man nicht gegen den Rand scrollt
  ...
  Widget _buildPage1Personal() {
    return Padding(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          // const Icon(Icons.person_outline, size: 80, color: Color(0xFF64FFDA)), // Icon optional, da oben schon eins war
          const Text(
            "Über dich",
            style: TextStyle(
              fontSize: 28,
